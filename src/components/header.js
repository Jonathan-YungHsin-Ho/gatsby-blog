    ...
    render={data => (
      <header className={styles.container}>
        <div className={styles.row}>
          ...
          <SocialButton
            site="github"
            username="Jonathan-YungHsin-Ho"
          ></SocialButton>
          <SocialButton site="linkedin" username="jonathan-y-ho"></SocialButton>
          <SocialButton site="twitter" username="JonathanHoDev"></SocialButton>
        </div>
        <div className={styles.row}>
